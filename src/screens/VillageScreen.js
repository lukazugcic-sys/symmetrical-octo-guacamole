  ...
  if (prestigeRazina >= 5) {
    return {
      shell: {
        ...
        gradient: ['#0E1622', '#1A2332'],
        shadow: 'rgba(163,230,53,0.15)',
        materialLabel: 'Kompozitni okvir · energetske šine',
        copy: 'Katovi su sada spojeni u tvrdu citadelu s vodljivim pragovima i jasnim energetskim vodovima. Svjetlo jezgre probija kroz sve.',
      ...
      floors: {
        0: {
          ...
          gradient: ['rgba(203,213,225,0.07)', 'rgba(203,213,225,0.04)'],
          shadow: 'rgba(203,213,225,0.10)',
        ...
        1: {
          ...
          gradient: ['rgba(163,230,53,0.08)', 'rgba(163,230,53,0.04)'],
          shadow: 'rgba(163,230,53,0.12)',
  ...
  if (prestigeRazina >= 3) {
    return {
      shell: {
        ...
        gradient: ['#101522', '#1A1F2E'],
        shadow: 'rgba(252,211,77,0.12)',
        materialLabel: 'Zakivene galerije · signalni pragovi',
        copy: 'Drvo je gotovo nestalo iz okvira. Selo sada djeluje planski, s tvrdim mostovima i jasnim zapovjednim linijama. Zrak je težak od autoriteta.',
